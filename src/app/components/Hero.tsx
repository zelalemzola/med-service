        ...
        />
            <div className="flex items-center gap-4 flex-wrap">
             <BlurFade delay={0.45} inView={true}>
              <Link href='/' className='bg-primary p-2 rounded-full text-white hover:shadow-lg text-lg md:text-xl'>Chat with a doctor</Link>
            </BlurFade>
            <BlurFade delay={0.55} inView={true}>
              <Link href='/' className='bg-white p-2 rounded-full text-primary hover:shadow-lg text-lg md:text-xl'>Contact Us</Link>
           </BlurFade>
            </div>
